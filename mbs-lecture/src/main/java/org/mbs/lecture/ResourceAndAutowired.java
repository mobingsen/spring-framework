 ...
 *  更新时间：2019年09月04日 14:59:21   转载 作者：zhangniuniu
 * 这篇文章主要介绍了Spring注解@Resource和@Autowired区别对比详解,文中通过示例代码介绍的非常详细，对大家的学习或者工作具有一定的参考
 * 学习价值,需要的朋友可以参考下
 *
 * 前言
 *
 * @Resource和@Autowired都是做bean的注入时使用，其实@Resource并不是Spring的注解，它的包是javax.annotation.Resource，需要导入，
 * 但是Spring支持该注解的注入。
 *
 * 1、共同点
 *
 ...
 * （2）@Resource
 *
 * @Resource默认按照ByName自动注入，由J2EE提供，需要导入包javax.annotation.Resource。@Resource有两个重要的属性：name和type，而
 ...
 * Created by mbs on 2020/8/20 21:13
 */
