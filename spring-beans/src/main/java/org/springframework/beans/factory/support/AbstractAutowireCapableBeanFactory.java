...
public abstract class AbstractAutowireCapableBeanFactory extends AbstractBeanFactory
	 ...
	 * Class objects. By default, only the BeanFactory interface is ignored.依赖接口忽略依赖检查和自动装配，作为集类的对象。 默认情况下，只有BeanFactory接口被忽略。
	 */
	...
	/** Cache of unfinished FactoryBean instances: FactoryBean name to BeanWrapper 未完成的FactoryBean实例的高速缓存：BeanWrapper的FactoryBean名称 */
