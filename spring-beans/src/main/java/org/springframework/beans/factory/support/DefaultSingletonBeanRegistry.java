...
public class DefaultSingletonBeanRegistry extends SimpleAliasRegistry implements SingletonBeanRegistry {
	...
	/** Map between containing bean names: bean name --> Set of bean names that the bean contains 包含的Bean名称之间的映射：Bean名称-> Bean包含的Bean名称集 */
	private final Map<String, Set<String>> containedBeanMap = new ConcurrentHashMap<>(16);

	/** Map between dependent bean names: bean name --> Set of dependent bean names 依赖bean名称之间的映射：Bean名称->依赖bean名称的集合 */
	private final Map<String, Set<String>> dependentBeanMap = new ConcurrentHashMap<>(64);

	/** Map between depending bean names: bean name --> Set of bean names for the bean's dependencies 在相关的Bean名称之间进行映射：Bean名称-> Bean依赖项的Bean名称集 */
