...
public class XmlBeanDefinitionReader extends AbstractBeanDefinitionReader {
	...
	/**
	 * Indicates that the validation should be disabled.指示验证应禁用。
	 */
	public static final int VALIDATION_NONE = XmlValidationModeDetector.VALIDATION_NONE;

	/**
	 * Indicates that the validation mode should be detected automatically.指示应该自动检测到验证模式。
	 */
	public static final int VALIDATION_AUTO = XmlValidationModeDetector.VALIDATION_AUTO;

	/**
	 * Indicates that DTD validation should be used.表示DTD验证应使用。
	 */
	public static final int VALIDATION_DTD = XmlValidationModeDetector.VALIDATION_DTD;

	/**
	 * Indicates that XSD validation should be used.指示应使用XSD验证。
	 */
	...
	private final XmlValidationModeDetector validationModeDetector = new XmlValidationModeDetector(); // Xml验证模式检测器
